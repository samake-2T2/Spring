                ...
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label>번호</label>
                                <input class="form-control" name='##' value="${vo.bno }" readonly>
                            </div>
                            <div class="form-group">
                                <label>작성자</label>
                                <input class="form-control" name='##' value="${vo.writer }" readonly>
                            </div>    
                            <div class="form-group">
                                <label>제목</label>
                                <input class="form-control" name='##' value="${vo.title }" readonly>
                            </div>

                            <div class="form-group">
                                <label>내용</label>
                                <textarea class="form-control" rows="10" name='##' readonly>${vo.content }</textarea>
                            </div>
